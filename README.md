...
![Descarga de Docker Desktop](imagenes/01-docker-descarga.png)

![Verificación de versiones Docker en terminal](imagenes/02-docker-version.png)
...
![Panel de ngrok con dominio asignado](imagenes/03-ngrok-dominio.png)
...
![Archivo docker-compose.yml en VS Code](imagenes/04-docker-compose-vscode.png)
...
![Contenedores corriendo en terminal](imagenes/05-contenedores-running.png)
...
![Pantalla de configuración inicial de n8n](imagenes/06-n8n-setup.png)

![Dashboard principal de n8n funcionando](imagenes/07-n8n-dashboard.png)
...
![Workflow con los dos nodos conectados](imagenes/08-workflow-nodos.png)

![Código JavaScript en el nodo Code](imagenes/09-workflow-codigo.png)

![Ejecución exitosa — Workflow executed successfully](imagenes/10-ejecucion-exitosa.png)
...
n8n_actividad/
├── imagenes/
│   ├── 01-docker-descarga.png
│   ├── 02-docker-version.png
│   ├── 03-ngrok-dominio.png
│   ├── 04-docker-compose-vscode.png
│   ├── 05-contenedores-running.png
│   ├── 06-n8n-setup.png
│   ├── 07-n8n-dashboard.png
│   ├── 08-workflow-nodos.png
│   ├── 09-workflow-codigo.png
│   └── 10-ejecucion-exitosa.png
├── docker-compose.yml
└── README.md
```
